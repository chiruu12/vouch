...
const MUTATIONS = [
  ...
  {
    name: "the refusal is appended below the payload instead of leading it",
    breaks: "the one line that stops a caller inventing an answer sits under two hundred lines of JSON",
    file: "src/mcp.ts",
    from: "  return [...head, JSON.stringify(payload, null, 2)].join(\"\\n\\n\");",
